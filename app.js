...
// "this" in joe.scope refers to the object it is contained within.
// 2. What is "this" when joe.scopeArrow() is invoked?
// "this" in joe.scopeArrow() refers to the global window object
// 3. Explain why "this" is different when an arrow function is used.
// Arrow functions do not hold the scope and instead take on the enclosing functional scope which in this case is the global window object.
